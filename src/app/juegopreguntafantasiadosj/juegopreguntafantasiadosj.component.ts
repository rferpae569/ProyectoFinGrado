...
export class JuegopreguntafantasiadosjComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.servicioService
      .getDatosPeliculaPistaPreguntaFantasia()
      .subscribe((datos) => {
        this.pistaPregunta = datos;
        this.cookieService.set(
          'pistas',
          JSON.stringify(this.pistaPregunta.slice(0, 19))
        ); //Esto para pistas
  ...
  constructor(
    ...
    if (!sessionCookieExists) {
      this.servicioService
        .getDatosPeliculaPreguntaFantasia()
        .subscribe((datos) => {
          this.datos = datos;
  ...
  generarArrayPreguntasPeliculas() {
    ...
    this.cookieService.set(
      'preguntas',
      JSON.stringify(this.preguntasPeliculas.slice(0, 19)),
      expirationDate
    );
    this.cookieService.set(
      'listapeliculas',
