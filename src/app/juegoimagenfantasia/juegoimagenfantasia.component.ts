...
@Component({
  selector: 'app-juegoimagenfantasia',
  templateUrl: './juegoimagenfantasia.component.html',
  styleUrls: ['./juegoimagenfantasia.component.scss']
})
export class JuegoimagenfantasiaComponent implements OnInit  {
