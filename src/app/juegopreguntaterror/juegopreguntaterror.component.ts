...
@Component({
  selector: 'app-juegopreguntaterror',
  templateUrl: './juegopreguntaterror.component.html',
  styleUrls: ['./juegopreguntaterror.component.scss'],
  animations: [
    trigger('slideDownUp', [
...
export class JuegopreguntaterrorComponent implements OnInit {
