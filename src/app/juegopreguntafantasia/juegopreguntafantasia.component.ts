...
@Component({
  selector: 'app-juegopreguntafantasia',
  templateUrl: './juegopreguntafantasia.component.html',
  styleUrls: ['./juegopreguntafantasia.component.scss'],
  animations: [
    trigger('slideDownUp', [
...
export class JuegopreguntafantasiaComponent implements OnInit {
