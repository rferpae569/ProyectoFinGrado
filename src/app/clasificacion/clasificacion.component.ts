      ...
      (datos: any[]) => {
        ...
        this.usuariosImagen = datos.map((usuario) => {
          return {
            ...
            totalImagen:
              usuario.PuntosImagenFantasia +
              usuario.PuntosImagenTerror +
              usuario.PuntosImagenFiccion,
          };
        });
        ...
        this.usuariosPreguntas = datos.map((usuario) => {
          return {
            ...
            totalPreguntas:
              usuario.PuntosPreguntasFantasia +
              usuario.PuntosPreguntasTerror +
              usuario.PuntosPreguntasFiccion,
          };
        });
        // Ordenar los usuarios por los tres criterios: imagen, preguntas y música
        ...
        this.usuariosMusica = datos.map((usuario) => {
          return {
            ...
            totalMusica:
              usuario.PuntosMusicaFantasia +
              usuario.PuntosMusicaTerror +
              usuario.PuntosMusicaFiccion,
          };
        });
        // Ordenar los usuarios por los tres criterios: imagen, preguntas y música
    ...
    this.usuariosImagen = data.sort((a, b) => {
      ...
      switch (event.active) {
        ...
        case 'puntosImagenFantasia':
          return this.compare(
            a.puntosImagenFantasia,
            b.puntosImagenFantasia,
            isAsc
          );
        case 'puntosImagenTerror':
          return this.compare(
            a.puntosImagenTerror,
            b.puntosImagenTerror,
            isAsc
          );
        case 'puntosImagenFiccion':
          return this.compare(
            a.puntosImagenFiccion,
            b.puntosImagenFiccion,
            isAsc
          );
        case 'totalImagen':
    ...
    this.usuariosPreguntas = data.sort((a, b) => {
      ...
      switch (event.active) {
        ...
        case 'PuntosPreguntasFantasia':
          return this.compare(
            a.PuntosPreguntasFantasia,
            b.PuntosPreguntasFantasia,
            isAsc
          );
        case 'PuntosPreguntasTerror':
          return this.compare(
            a.PuntosPreguntasTerror,
            b.PuntosPreguntasTerror,
            isAsc
          );
        case 'PuntosPreguntasFiccion':
          return this.compare(
            a.PuntosPreguntasFiccion,
            b.PuntosPreguntasFiccion,
            isAsc
          );
        case 'totalPreguntas':
    ...
    this.usuariosMusica = data.sort((a, b) => {
      ...
      switch (event.active) {
        case 'PuntosMusicaFantasia':
          return this.compare(
            a.PuntosMusicaFantasia,
            b.PuntosMusicaFantasia,
            isAsc
          );
        case 'PuntosMusicaTerror':
          return this.compare(
            a.PuntosMusicaTerror,
            b.PuntosMusicaTerror,
            isAsc
          );
        case 'PuntosMusicaFiccion':
          return this.compare(
            a.PuntosMusicaFiccion,
            b.PuntosMusicaFiccion,
            isAsc
          );
        case 'totalMusica':
